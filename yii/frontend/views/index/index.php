...
<head>
    ...
    <link rel="Shortcut Icon" href="images/post2.jpg" type="image/x-icon">
    ...
    <div class="container-fluid">
        <div class="col-md-6 top-left">
            <ul>
                ...
                <li><i class="fa fa-map-marker" aria-hidden="true"></i> 上海</li>
            </ul>
        </div>
            ...
            <div class="header-nav">
                <nav class="">
                    ...
                    <div class="navbar-header">
                        ...
                        <h2><a class="navbar-brand" href="javascript:void(0)" style="font-size: 35px;">stop-<span> and-go</span></a></h2>
                    </div>
                    <!-- Collect the nav links, forms, and other content for toggling -->
                    <div >
                        <nav class="cl-effect-15" id="cl-effect-15">
                            <ul>
                                <li><a href="#home" class="active" data-hover="首页">首页</a></li>
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-hover="出境游" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">出境游<span class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-hover="国内游" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">国内游 <span class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="#gallery" class="scroll" data-hover="Gallery">Gallery</a></li>
                                        <li><a href="#testimonials" class="scroll" data-hover="Testimonials">Testimonials</a></li>
                                    </ul>
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-hover="周边游" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">周边游 <span class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="#gallery" class="scroll" data-hover="Gallery">Gallery</a></li>
                                        <li><a href="#testimonials" class="scroll" data-hover="Testimonials">Testimonials</a></li>
                                    </ul>
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-hover="景点门票" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">景点门票 <span class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="#gallery" class="scroll" data-hover="Gallery">Gallery</a></li>
                                        <li><a href="#testimonials" class="scroll" data-hover="Testimonials">Testimonials</a></li>
                                    </ul>
                                </li>
                                <li><a href="#contact" class="scroll" data-hover="定制游">定制游</a></li>
                            </ul>
                        </nav>
                    </div>
                </nav>
                <div class="w3ls_search">
                    <div class="cd-main-header">
                        <ul class="cd-header-buttons">
                            <li style="padding-top: 14px;"><a class="cd-search-trigger" href="#cd-search"> <span></span></a></li>
...
<!--必抢系列-->
<div id="gallery" >
    <h3 class="heading">必秒专区</h3>
    <div >
        <div class="bs-example bs-example-tabs" role="tabpanel" >

            <div  id="all" aria-labelledby="home-tab">
                    ...
                    <div class=" col-md-3">
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <p>...</p>
                                <h3 style="color:#146EB4;">剩余时间：00时03分45秒</h3>
                            </div>
                        </div>
                    </div>
                    <div class=" col-md-3">
...
<div id="gallery" class="gallery">
    <h3 class="heading">会员专享</h3>
    <div class="w3ls_banner_bottom_grids">
        <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
            <ul id="myTab" class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active"><a href="#all" id="home-tab" role="tab" data-toggle="tab" aria-controls="all" aria-expanded="true">周边钜惠</a></li>
                <li role="presentation"><a href="#group" role="tab" id="group-tab" data-toggle="tab" aria-controls="group">特惠国内</a></li>
                <li role="presentation"><a href="#asana" role="tab" id="asana-tab" data-toggle="tab" aria-controls="asana">欢乐门票</a></li>
                <li role="presentation"><a href="#products" role="tab" id="products-tab" data-toggle="tab" aria-controls="products">当季爆品</a></li>
            </ul>
...
<!--楼层-->
<div id="gallery" class="gallery">
    <h3 class="heading">出境畅游</h3>
    <div class="w3ls_banner_bottom_grids">
        <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
            <ul id="myTab" class="nav nav-tabs" role="tablist">
                <li ><a href="javascript:void(0)"  >周边钜惠</a></li>
                <li ><a href="javascript:void(0)" >特惠国内</a></li>
                <li ><a href="javascript:void(0)" >欢乐门票</a></li>
                <li ><a href="javascript:void(0)">当季爆品</a></li>
            </ul>
            <div id="myTabContent" class="tab-content">
                <div role="tabpanel" id="all" aria-labelledby="home-tab">
                    <div class="col-md-3 w3layouts_gallery_grid">
                        <a title="Donec sapien massa, placerat ac sodales ac, feugiat quis est." href="images/15.jpg">
                            <div class="w3layouts_team_grid">
                                <img src="images/15.jpg" alt=" " class="img-responsive" />
...
<div class="about" id="about">
    <div class="container" style="width: 1000px;">
        ...
        <div class="col-md-6 about-left">
            <span class="col-md-2">A</span>
            <p class="col-md-10" style="color: #0d97c1;">lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean lectus orci, volutpat at diam et,
                tincidunt malesuada turpis. In viverra diam turpis, nec porttitor turpis feugiat in. Pellentesque.</p>
            <p style="color: #0d97c1;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean lectus orci, volutpat at diam et,
                tincidunt malesuada turpis. In viverra diam turpis, nec porttitor turpis feugiat in. Pellentesque.</p>
            <p style="color: #0d97c1;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean lectus orci, volutpat at diam et,
                tincidunt malesuada turpis. In viverra diam turpis, nec porttitor turpis feugiat in. Pellentesque.</p>
        </div>
...
<div data-vide-bg="video/Ipad">
    <div class="center-container">
        <div class="video-info">
            <div class="container">
                <h3 class="heading1">Awesome Traveller video</h3>
...
<div class="contact" id="contact">
    <div class="container">
        <h3 class="heading">The tour guide to help</h3>
        <div class="agileits_w3layouts_team_grids">
            <div class="col-md-3 agileits_w3layouts_team_grid">
                <h3>Jane Richard</h3>
    ...
    <div class="footer-main">
        <div class="col-md-4 ftr-grid">
            ...
            <div class="col-md-10 address add">
                ...
                <p>3rd Block,Magestic Residency,korea</p>
...
<div class="footer-w3layouts">
    <div class="container" style="width: 1200px; ">
        <div class="agile-copy">
            <p>Copyright &copy;上海走走停停兴旅国际旅行社有限公司。旅行社业务经营许可证编号：L-SH-CJ00056</p>
        </div>
...
<script type="text/javascript">
    ...
    $("#Inputphone").blur(function(){
        var zhi=$(this).val();
        if(zhi==''){
            $(this).nextAll('span').html('手机号不能为空');
            return   false;
        }else{
            var zheng=/^1[3578]\d{9}$/;
            if(zheng.test(zhi)){
                $(this).nextAll('span').html("");
                a=true;
            }else{
                $(this).nextAll('span').html("请填写你正确的手机号码");
                return false;
            }
        }
    })
    $("#InputPwd").blur(function(){
        ...
        if(zhi==''){
            ...
            if(zheng.test(zhi)){
                ...
                $(this).nextAll('span').html('密码为6-20位任意数字字母或下划线');
                return false;
            }
        }
    })
    $('#dl').click(function(){
        var zhi1=$("#Inputphone").val();
        var zhi2=$("#InputPwd").val();
        var token ="{{csrf_token()}}";
        if(a&&b==true){
            //alert(1);
            $.ajax({
                url:"{{url('home/enter')}}",
                data:{"zhi1":zhi1,"zhi2":zhi2,"_token":token},
                dataType:"JSON",
                type:"post",
